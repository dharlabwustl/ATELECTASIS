...
get_all_CSV_PDF_OF_A_RESOURCE_IN_A_PROJECT()
{
# def get_maskfile_scan_metadata():
working_directory=${1} #sys.argv[1]
resource_dirfolder=${2}
...
sys.path.append('/software');
from download_with_session_ID import *;
call_get_all_CSV_PDF_OF_A_RESOURCE_IN_A_PROJECT()"  ${working_directory} ${resource_dirfolder}
}
...
get_all_CSV_PDF_OF_A_RESOURCE_IN_A_PROJECT ${working_dir} ${snipr_output_foldername}
